...
TEST(capi, resolve_instantiate_functions)
{
    ...
    */
    ...
    FizzyExternalFunction mod1foo1 = {{FizzyValueTypeI32, &input_type, 1},
        {{{host_fn, &result_int32}}, FizzyExecuteFunctionHost}};
    FizzyValue result_int64{43};
    FizzyExternalFunction mod1foo2 = {{FizzyValueTypeI64, &input_type, 1},
        {{{host_fn, &result_int64}}, FizzyExecuteFunctionHost}};
    FizzyValue result_f32;
    result_f32.f32 = 44.44f;
    FizzyExternalFunction mod2foo1 = {
        {FizzyValueTypeF32, &input_type, 1}, {{{host_fn, &result_f32}}, FizzyExecuteFunctionHost}};
    FizzyValue result_f64;
    result_f64.f64 = 45.45;
    FizzyExternalFunction mod2foo2 = {
        {FizzyValueTypeF64, &input_type, 1}, {{{host_fn, &result_f64}}, FizzyExecuteFunctionHost}};
...
TEST(capi, resolve_instantiate_globals)
{
   ...
   */
    ...
    FizzyImportedFunction mod1foo1 = {"mod1", "foo1",
        {{FizzyValueTypeVoid, nullptr, 0}, {{{NullFn, nullptr}}, FizzyExecuteFunctionHost}}};
