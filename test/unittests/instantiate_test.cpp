...
namespace
{
ExecutionResult host_fn_1(std::any&, Instance&, const Value*, ExecutionContext&) noexcept
{
    return Trap;
}

ExecutionResult host_fn_2(std::any&, Instance&, const Value*, ExecutionContext&) noexcept
{
    return Trap;
}
