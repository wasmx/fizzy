...
TEST(instantiate, imported_functions)
{
    ...
    */
    ...
    auto host_foo = [](Instance&, span<const Value>, ThreadContext&) { return Trap; };
...
TEST(instantiate, imported_functions_multiple)
{
    ...
    */
    ...
    auto host_foo1 = [](Instance&, span<const Value>, ThreadContext&) { return Trap; };
    auto host_foo2 = [](Instance&, span<const Value>, ThreadContext&) { return Trap; };
    auto instance =
...
TEST(instantiate, element_section_fills_imported_table)
{
    ...
    */
    ...
    auto f0 = [](Instance&, span<const Value>, ThreadContext&) { return Value{0}; };
